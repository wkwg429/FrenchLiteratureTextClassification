...
"""特征存储的路径"""
features_path = '../features/data_tfidf_select_LSVC_l2_8082.pkl'
...
clfs = {
    ...
    'bagging': BaggingClassifier(estimator=base_clf, n_estimators=60, max_samples=1.0, max_features=1.0, random_state=1,
                        n_jobs=1, verbose=1),
    'rf': RandomForestClassifier(n_estimators=10, criterion='gini'),
    'adaboost': AdaBoostClassifier(estimator=base_clf, n_estimators=50, algorithm='SAMME'),
    ...
    'lgb': lgb.LGBMClassifier(boosting_type='gbdt', num_leaves=31, max_depth=-1, learning_rate=0.1, n_estimators=250,
                              ...
                              reg_lambda=0.5, random_state=None, n_jobs=-1)
}
clf = clfs[clf_name]
