...
t_start = time.time()
features_name = ['data_tfidf.pkl', 'data_lsa.pkl', 'data_lda.pkl', 'data_tfidf_select_LSVC_l2_927.pkl',
                 'data_doc2vec_25.pkl', 'data_ensemble.pkl', 'data_ensemble_spar.pkl']
# 'data_tf.pkl',
...
for feature in features_name:
    ...
    result_file_path = os.path.join('../results/spanish/', filename)
...
with open('../results/spanish/all.csv', 'w', newline='') as file:
    writer = csv.DictWriter(file,
                            fieldnames=['Feature', 'Classification', 'Accuracy', 'Precision', 'Recall', 'F1 Score'])
    writer.writeheader()
